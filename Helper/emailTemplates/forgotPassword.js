        ...
        <tr>
            <td>
                <table cellspacing='0' cellpadding='0' style='max-width:600px; background: #fff;width:100%; margin:0 auto;padding:0;box-sizing:border-box;border-collapse:collapse; box-shadow: 0px 1px 2px 1px rgba(154, 154, 204, 0.22);'>
                    ...
                    <tr>
                        <td style='padding:20px 0px 70px;width:100%;box-sizing:border-box; text-align:center; '>
                         <a href='{{privacyUrl}}' style='display:inline-block; color:#333; margin:0px 2px 5px; font-size:12px; text-decoration:underline'>Privacy Policy</a> <a href='{{termsUrl}}' style='display:inline-block; color:#333; margin:0px 2px 5px; font-size:12px; text-decoration:underline;'>Terms &amp; Conditions </a>
